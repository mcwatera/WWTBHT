"""
Django settings for wwtbht project.
...
SECRET_KEY = 'bhr-v@!2+w^1ctrf21!24orkk_4edd6g*v3)tzhsf1&6x(c5@k'
...
WSGI_APPLICATION = 'wwtbht.wsgi.application'
